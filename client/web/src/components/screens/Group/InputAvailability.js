...
const mapStateToProps = ({ AddAvailabilityReducer }) => {
    const {modalVisible, rangeHours, selectedDate, availableDays, groupInformation, memberId} = AddAvailabilityReducer;
    return {modalVisible, rangeHours, selectedDate, availableDays, groupInformation, memberId};
};
