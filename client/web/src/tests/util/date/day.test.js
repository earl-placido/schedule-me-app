...
import { convertDatesToDay, convertAvailabilityToDays } from "../../../actions/util/date/day";
...
it("test convertAvailabilityToDays", () => {
  ...
  const newAvailabilityDays = convertAvailabilityToDays(availableDays, availabilities);
